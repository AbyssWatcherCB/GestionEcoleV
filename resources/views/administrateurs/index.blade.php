...
<head>
    ...
    <title>List Administrateurs</title>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">List Administrateurs</h1>
                    <div class="card mb-4">
                        <div class="card-header">
                            <i class="fas fa-table me-1"></i>
                            <a href="{{ route('administrateurs.create') }}">Ajouter un administrateur</a>
                        </div>
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('administrateurs.show', $administrateur->id) }}">Details</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
